    ...
    <section className="flex flex-col gap-8 pt-12" id="education">
      ...
      <div className="flex gap-10">
        <div className="flex gap-4 text-sm sm:text-base">
          <Link href={'mailto:kausthubhjrao@gmail.com'} className="mt-1 opacity-85 hover:opacity-100 flex items-center gap-1">
            <MailIcon className="size-4" />
            <span>Email</span>
          </Link>
          <Link href={'https://x.com/exgene'} className="mt-1 opacity-85 hover:opacity-100 flex items-center gap-1">
